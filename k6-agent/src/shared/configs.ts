...
export const SCRIPTS_REPO_DIR = process.env.SCRIPTS_REPO_DIR || path.join(K6_BASE_PATH, 'k6-scripts-repo');
export const MAX_RESULT_FILES = parseInt(process.env.MAX_RESULT_FILES || '500', 10);
export const MAX_HISTORY_PER_SCRIPT = parseInt(process.env.MAX_HISTORY_PER_SCRIPT || '50', 10);
